...
# Frontend Moderno (Tema Azul Profesional)
...
# ------------------------------------------------------------
COLOR_FONDO = "#F3F6FB"          # Fondo gris-azulado claro
COLOR_PANEL = "#FFFFFF"          # Paneles blancos
COLOR_TEXTO = "#1A237E"          # Azul oscuro profesional
COLOR_PRINCIPAL = "#1565C0"      # Azul corporativo
COLOR_BOTON_HOVER = "#0D47A1"    # Azul más intenso
COLOR_VOLVER = "#E3F2FD"         # Azul muy suave
COLOR_VOLVER_HOVER = "#BBDEFB"   # Hover suave para volver
...
ttk.Label(ventana, text="© 2025 - Jave’s Laundry\nHecho por: Wicho y Arenz",
          ...
          background=COLOR_FONDO, foreground="#1565C0").pack(side=tk.BOTTOM, pady=20)
